$(document).ready(function(){
    ...
    $('#frmEstado').find('input, button').prop('disabled', true);
});

$("#Editar").click(function(){
    $('#frmEstado').find('input, button').prop('disabled', false);
    ponerFoco("nombre");
...
$("#Guardar").click(function() {
    ...
    if (msj == "")
        ModificarEstado("ModificarEstado", datos);
    else {
...
function ModificarEstado(url, datos)
{
    $.ajax({
        url:url,
        type:'POST',
